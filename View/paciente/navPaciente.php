        ...
        <div class="collapse navbar-collapse" id="navbarColor01">
            ...
            <div class="menu-right nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="index.php?pid=<?php echo base64_encode("") ?>">Información Personal</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="index.php?pid=<?php echo base64_encode("") ?>">Cambiar contraseña</a>
                    </div>
                </div>

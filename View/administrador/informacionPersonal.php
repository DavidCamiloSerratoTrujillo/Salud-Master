<?php
    ...
    if(isset($_POST['actualizarinfoAdmin'])){
        $nombre = $_POST['nombre'];
        $user = $_POST['user'];
        ...
        if ($Administrador->getUsuario() != $user && ($Paciente->existeCorreo() || $Medico->existeCorreo() || $Administrador->existeNuevoCorreo($user))) {
            ...
            $Administrador = new Administrador($idAdmin,$nombre,$user,"");
